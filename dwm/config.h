...
//	{ MODKEY,                       XK_n,      focusstack,     {.i = +1 } }, // change focus to the left 
//	{ MODKEY,                       XK_m,      focusstack,     {.i = +1 } }, // change focus to the left 
	...
	{ MODKEY,                       XK_Tab,    view,           {0} }, // skip to previous tag 
	...
	{ MODKEY|ShiftMask,             XK_0,      tag,            {.ui = ~0 } }, // set focus window on all tags 
	{ MODKEY,                       XK_comma,  focusmon,       {.i = -1 } }, // focus monitor down 
	{ MODKEY,                       XK_period, focusmon,       {.i = +1 } }, // focus monitor up 
	{ MODKEY|ShiftMask,             XK_comma,  tagmon,         {.i = -1 } }, // move focus window to monitor down 
	{ MODKEY|ShiftMask,             XK_period, tagmon,         {.i = +1 } }, // move focus window to monitor up
